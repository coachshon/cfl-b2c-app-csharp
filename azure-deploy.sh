...
azureSQL='Server=tcp:sql-cfl-api-dev.database.windows.net,1433;Initial Catalog=sqldb-cfl-api;Persist Security Info=False;User ID=hyonadmin;Password=9ZNkJe5BVZV;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;'

#gitSource="https://github.com/Azure-Samples/azure-sql-db-fullstack-serverless-kickstart"
gitSource="https://github.com/coachshon/cfl-b2c-app-csharp"
gitToken=""
EOF
